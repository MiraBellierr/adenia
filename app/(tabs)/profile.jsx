    ...
    <SafeAreaView className="flex-1 bg-[#AFEEEE]">
      ...
      <View className="p-6">
        <View className="flex-row items-center mb-4">
          ...
          <Text className="flex-1 ml-4 text-lg">{user.name}</Text>
        </View>
        <View className="flex-row items-center mb-4">
          <Ionicons name="calendar-outline" size={24} color="purple" />
          <Text className="flex-1 ml-4 text-lg">{user.age || 'Age not provided'}</Text>
        </View>
        <View className="flex-row items-center mb-4">
          <Ionicons name="call-outline" size={24} color="purple" />
          <Text className="flex-1 ml-4 text-lg">{user.phone || 'Phone number not provided'}</Text>
        </View>
        <View className="flex-row items-center mb-4">
        ...
        <TouchableOpacity onPress={navigateToEditProfile} className="bg-purple-600 p-4 rounded-full items-center mt-6">
