...
const EditProfileScreen = () => {
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      await updateProfile(user.$id, username, parseInt(age), phone);
      ...
      <SafeAreaView className="flex-1 bg-[#F5F5F5]">
        ...
        <View className="p-6">
          <View className="flex-row items-center mb-4">
            ...
            <TextInput
              className="flex-1 ml-4 text-lg border-b border-[#6200EA]"
              value={username}
          ...
          <TouchableOpacity onPress={handleSaveProfile} className="bg-[#6200EA] p-4 rounded-full items-center mt-6 shadow-md">
