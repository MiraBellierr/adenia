...
import { getAccount, updateProfile } from '../../lib/appwrite'; // Adjust the path to your appwrite.js
      ...
      <SafeAreaView style={tw`flex-1 bg-[#AFEEEE]`}>
        ...
        <View style={tw`p-6`}>
          <View style={tw`flex-row items-center mb-4`}>
            ...
            <TextInput
              style={tw`flex-1 ml-4 text-lg border-b border-purple-600`}
              value={username}
          ...
          <TouchableOpacity onPress={handleSaveProfile} style={tw`bg-purple-600 p-4 rounded-full items-center mt-6`}>
