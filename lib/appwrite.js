...
export const appwriteConfig = {
  ...
  medicineCollectionId: "6666b852002dfb3d25b0",
};
...
export const addMedication = async (userId, medicineName, dose, time) => {
  const response = await databases.createDocument(
    appwriteConfig.databaseId,
    appwriteConfig.medicineCollectionId,
    ID.unique(),
    {
      userId,
      medicineName,
...
export const deleteMedication = async (documentId) => {
